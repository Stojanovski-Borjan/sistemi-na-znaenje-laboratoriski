...
gradenje_drvo = build_tree(training_data, entropy)

klasifikacija = classify(test_case, gradenje_drvo)

sortirano = sorted(klasifikacija.items(), key=lambda x: x[1], reverse=True)[0][0]
